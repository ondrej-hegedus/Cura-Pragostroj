...
Cura.MachineAction
{
    ...
    Column
    {
        ...
        Label
        {
            ...
            wrapMode: Text.WordWrap
            renderType: Text.NativeRendering
            text: "TTTTo print directly to your printer over the network, please make sure your printer is connected to the network using a network cable or by connecting your printer to your WIFI network. If you don't connect Cura with your printer, you can still use a USB drive to transfer g-code files to your printer."
        }
