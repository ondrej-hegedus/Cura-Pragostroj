...
Item {
    ...
    property alias color: tmptxt.color;
    // property alias color: shader.color;
    property alias sourceSize: img.sourceSize;

    // Temporary invisible object to reference property 'color' somewhere
    Text {
        id: tmptxt;
    }
    ...
    // This is here, just because it down't work without it. Propably because all Item's parameters must be used at least once
    // Or even more possible, because of shader.color property of the Item
    // ShaderEffect {
    //     id: shader;
    //     anchors.fill: parent;
    //     visible: false;
