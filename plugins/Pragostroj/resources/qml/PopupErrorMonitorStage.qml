...
Item
{
    ...
    {
        id: popupBackground
        visible: OutputDevice.errorPopup.show
        // visible: false
        anchors.fill: parent
    ...
    Rectangle
    {
        ...
        Label
        {
            ...
            text: OutputDevice.errorPopup.errorLine1
            // text: "Error text -hardcoded"
            font.pixelSize: 22
        }
        Label
        {
            ...
            text: OutputDevice.errorPopup.errorLine2
            // text: "TEST TEXT 3"
            font.pixelSize: 18
        }
        QueueButton
